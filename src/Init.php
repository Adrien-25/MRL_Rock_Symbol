...
final class Init
{
    ...
    public static function get_services()
    {
        return [
            ...
            Base\YoutubeController::class,
            Base\DiaporamaController::class,
            Base\EnteteController::class,
            Base\BienfaiteursController::class,
            Base\HistoriqueController::class,
        ];
    }
